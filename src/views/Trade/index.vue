<template>
    <div class="trade-container">
        ...
        <div class="content">
            ...
            <div class="detail">
                <h5>商品清单</h5>
                <ul class="list clearFix" v-for="list in trade.detailArrayList" :key="list.id">
                    <li>
                        <img style="width: 100px" :src="list.imgUrl" alt="" />
                    </li>
                    <li>
                        <p>
                            {{ list.skuName }}
...
export default {
    ...
    async mounted() {
        ...
        this.trade = trade
        this.selectAddressId = trade.userAddressList.find((address) => address.isDefault === '1').id
    },
}
</script>
